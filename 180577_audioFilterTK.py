...
def iirOptions(event):
    ...
    if int(en1.current())==0:
        ...
        lbln=Label(mainWindow, text="Input Numerator Coefficients of decreasing order of power of z:", fg='blue', font=("Helvetica", 10))
        lbln.place(x=90,y=170)
        num_=Entry(mainWindow, textvariable=nvar)
        num_.delete(0, 'end')
        num_.insert(END, str(1))
        
        lbld=Label(mainWindow, text="Input Denominator Coefficients of decreasing order of power of z:", fg='blue', font=("Helvetica", 10))
...
def give_options(i):
    ...
    if(i==1):
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : IIR_filter_cutoff(f,o,filter_type="lowpass"))
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : IIR_filter_cutoff(f,o,filter_type="highpass"))
        btn.place(x=100, y=350)
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : IIR_filter_cutoff(np.array([f1,f2]),o,filter_type="bandpass"))
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : IIR_filter_cutoff(np.array([f1,f2]),o,filter_type="bandstop"))
        btn.place(x=100, y=410)
...
def give_options1(i):
    ...
    if(i==1):
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : FIR_filter_cutoff(f,o,window_type=win,filter_type="lowpass"))
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : FIR_filter_cutoff(f,o,window_type=win,filter_type="highpass"))
        btn.place(x=100, y=440)
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : FIR_filter_cutoff(np.array([f1,f2]),o,window_type=win,filter_type="bandpass"))
        ...
        btn=Button(mainWindow, text="Get Filter Response!", command=lambda : FIR_filter_cutoff(np.array([f1,f2]),o,window_type=win,filter_type="bandstop"))
        btn.place(x=100, y=500)
...
fplot=Button(mainWindow, text="Plot Filter Response and zeros/poles", command=lambda : plot_filter(filter_impulse_response, filter_freq_resp, frequencies, zeros, poles))
